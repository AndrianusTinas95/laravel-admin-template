                                    ...
                                    <div class="feed-element">
                                        <a class="float-left" href="profile.html">
                                            <img alt="image" class="rounded-circle"
                                                src="{!! asset('/Inspinia/img/profile.jpg')!!}">
                                        </a>
...
@include('Inspinia.layouts.partial.chat')
@endsection

@push('plugin-js')
@include('Inspinia.layouts.assets.js.complete')
