        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="small float-right col-md-3 m-t-md text-right">
                    <strong>There are many</strong> variations of passages of Lorem Ipsum available, but the majority
                    have suffered.
                </div>
...
@push('plugin-js')
<!-- Flot -->
@include('Inspinia.layouts.assets.js.flot')
